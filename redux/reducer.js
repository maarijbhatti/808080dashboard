...
const Reducer = createSlice({
  ...
  reducers: {
    ...
    SalesMan_BannerType: (state, action) => {
      state.salesMan_BannerType = action.payload;
    },
    ...
    Customer_data_by_admin: (state, action) => {
      state.customer_data_by_admin = action.payload;
    },
  },
});
